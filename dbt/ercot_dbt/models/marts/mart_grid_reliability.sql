...
joined as (
    select
        ...
        demand_generation.total_generation_mwh
        - coalesce(interchange.interchange_mwh, 0)
            as net_available_generation_mwh

    from demand_generation
    left join interchange
        on
            demand_generation.period = interchange.period
...
metrics as (
    select
        ...
        (net_available_generation_mwh - demand_mwh)
        / nullif(demand_mwh, 0) as reserve_margin_pct
