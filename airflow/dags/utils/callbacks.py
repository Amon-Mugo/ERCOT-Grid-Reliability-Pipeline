...
def task_failure_alert(context: dict) -> None:
    ...
    try:
        ...
        execution_date = context.get("logical_date") or context.get(
            "execution_date")  # get execution date
        ...
        with smtplib.SMTP("smtp.gmail.com", 587, timeout=10) as server:
            ...
            # login with gmail_user and gmail_app_password
            server.login(gmail_user, gmail_app_password)
            # send email from gmail_user to recipients
